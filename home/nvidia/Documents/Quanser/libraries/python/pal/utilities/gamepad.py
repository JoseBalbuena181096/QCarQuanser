...
class LogitechF710:
    ...
    Attributes:
        ...
        leftLateralAxis (float): Left lateral axis value.
        leftLongitudinolAxis (float): Left longitudinal axis value.
        trigger (float): Trigger value.
        rightLateralAxis (float): Right lateral axis value.
        rightLongitudinolAxis (float): Right longitudinal axis value.
    ...
    # Continuous axis
    leftLateralAxis = 0
    leftLongitudinolAxis = 0
    trigger = 0
    rightLateralAxis = 0
    rightLongitudinolAxis = 0
    ...
    def read(self):
        ...
        Continuous:
            leftLateralAxis: Left Lateral stick (-1 to 1)
            leftLongitudinolAxis: Left Longitudonal stick (-1 to 1)
            rightLateralAxis: Right Lateral stick (-1 to 1)
            rightLongitudinolAxis: Right Longitudonal stick (-1 to 1)
        ...
        self.leftLateralAxis = -1 * data.x
        self.leftLongitudinolAxis = -1 * data.y
        self.rightLateralAxis = -1 * data.rx
        self.rightLongitudinolAxis = -1 * data.ry
