...
class Signal(_SignalInfo):
    ...
    defaultStyles = [
        _SignalInfo(color=[196,78,82], width=3, lineStyle='-'),
        _SignalInfo(color=[85,85,85], width=3, lineStyle='-.'),
        _SignalInfo(color=[85,168,104], width=3, lineStyle=':'),
        _SignalInfo(color=[76,114,176], width=3, lineStyle='--'),
        _SignalInfo(color=[248,217,86], width=3, lineStyle='-.'),
        _SignalInfo(color=[129,114,179], width=3, lineStyle='-..'),
        _SignalInfo(color=[221,132,82], width=3, lineStyle='-'),
    ]
...
class Scope():
    ...
    def __init__(self, title=None, **kwargs):
        ...
        """
        self._ms = MultiScope(title=title)
